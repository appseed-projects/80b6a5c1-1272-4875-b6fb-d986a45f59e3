...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-27 19:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/80b6a5c1-1272-4875-b6fb-d986a45f59e3.git
$ cd 80b6a5c1-1272-4875-b6fb-d986a45f59e3
```
